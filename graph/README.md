---
description: shortest path and min spanning tree
---

# graph

graph has 2 main types of problems: shortest path and minimum spanning tree. it's part of the subject discrete mathematics.&#x20;
